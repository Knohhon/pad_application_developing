...
class AddressRepository:
    ...
    async def get_user_addresses(
        self, session: AsyncSession, user_id: UUID, include_inactive: bool = False
    ) -> List[Address]:
    ...
    async def create(
        self, session: AsyncSession, address_data: AddressCreate
    ) -> Address:
        """Создать новый адрес"""
    ...
    async def update(
        self, session: AsyncSession, address_id: UUID, address_data: AddressUpdate
    ) -> Address:
    ...
    async def delete(self, session: AsyncSession, address_id: UUID) -> None:
        ...
        from models.database_models import \
            Order  # Импорт внутри функции для избежания циклических зависимостей
